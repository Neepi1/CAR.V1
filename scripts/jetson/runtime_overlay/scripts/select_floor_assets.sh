...
export NJRH_NAV_MAP_ID='${NJRH_NAV_MAP_ID}'
export NJRH_MAP_ID='${NJRH_MAP_ID}'
export NJRH_MAP_ASSET_EPOCH='${NJRH_MAP_ASSET_EPOCH}'
export NJRH_MAP_ASSET_DIGEST='${NJRH_MAP_ASSET_DIGEST}'
