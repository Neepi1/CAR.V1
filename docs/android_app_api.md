...
- Final chain: `/cmd_vel_api -> robot_safety -> /cmd_vel -> ranger_base_node`; `/cmd_vel_safe` is a robot_safety mirror for diagnostics, and `ranger_mini3_mode_controller` is not in the critical speed path.
