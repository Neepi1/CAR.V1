...
- Isaac occupancy-grid relocalization consumes canonical `/lidar_points_nav` for the stationary global match; FAST-LIO2 is not the default continuous local odom source underneath navigation.
