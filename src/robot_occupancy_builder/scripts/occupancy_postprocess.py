...
class OccupancyAccumulator:
    ...
    def write_assets(
        ...
        neutral_mask_pixels = [254] * (self.width * self.height)
        save_pgm(keepout_mask_pgm, self.width, self.height, neutral_mask_pixels)
        save_pgm(speed_mask_pgm, self.width, self.height, neutral_mask_pixels)
        save_pgm(binary_mask_pgm, self.width, self.height, neutral_mask_pixels)
