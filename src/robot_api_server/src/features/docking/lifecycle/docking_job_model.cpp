...
std::string docking_job_json(const DockingJob & job)
{
  ...
  response << "{\"id\":" << job.id << ","
           ...
           << (job.predock_nav_contact_detected ? "true" : "false") << ","
           << "\"predock_nav_canceled_for_contact\":"
           << (job.predock_nav_canceled_for_contact ? "true" : "false") << ","
           << "\"predock_contact_stop_confirmed\":"
           << (job.predock_contact_stop_confirmed ? "true" : "false") << ","
           << "\"predock_contact_stop_duration_sec\":"
           << job.predock_contact_stop_duration_sec << ","
           << "\"predock_contact_reason\":" << json_string(job.predock_contact_reason) << ","
           << "\"predock_contact_detected_at\":"
           << json_string(job.predock_contact_detected_at) << ","
           << "\"predock_contact_stop_detail\":"
           << json_string(job.predock_contact_stop_detail) << ","
           << "\"predock_nav_early_handoff\":"
           << (job.predock_nav_early_handoff ? "true" : "false") << ","
           << "\"predock_nav_handoff_detail\":"
           << json_string(job.predock_nav_handoff_detail) << ","
           ...
           << (job.predock_yaw_verified_by_nav2 ? "true" : "false") << ","
           << "\"reverse_yaw_offset_applied\":"
           << (job.reverse_yaw_offset_applied ? "true" : "false") << ","
           << "\"contact_frame_available\":"
           << (job.contact_frame_available ? "true" : "false") << ","
           ...
           << "\"predock_forward_m\":" << job.predock_forward_m << ","
           << "\"predock_lateral_m\":" << job.predock_lateral_m << ","
           << "\"predock_lateral_abs_m\":" << job.predock_lateral_abs_m << ","
           << "\"dock_insertion_yaw_map\":" << job.dock_yaw << ","
           << "\"expected_base_yaw_at_predock\":" << job.predock_expected_base_yaw << ","
           << "\"expected_contact_yaw_at_predock\":" << job.predock_expected_contact_yaw << ","
           << "\"current_base_yaw_map\":" << job.predock_current_base_yaw << ","
           << "\"current_contact_yaw_map\":" << job.predock_current_contact_yaw << ","
           << "\"base_yaw_error\":" << job.predock_base_yaw_error_rad << ","
           << "\"contact_yaw_error\":" << job.predock_contact_yaw_error_rad << ","
           ...
           << (job.predock_lateral_align_attempted ? "true" : "false") << ","
           << "\"predock_lateral_aligned\":"
           << (job.predock_lateral_aligned ? "true" : "false") << ","
           << "\"predock_lateral_align_succeeded\":"
           << (job.predock_lateral_align_succeeded ? "true" : "false") << ","
           << "\"predock_lateral_align_active\":"
           << (job.predock_lateral_align_active ? "true" : "false") << ","
           << "\"predock_lateral_align_initial_error_m\":"
           << job.predock_lateral_align_initial_error_m << ","
           << "\"predock_lateral_align_final_error_m\":"
           << job.predock_lateral_align_final_error_m << ","
           << "\"predock_lateral_align_duration_sec\":"
           << job.predock_lateral_align_duration_sec << ","
           << "\"predock_lateral_align_observed_motion_m\":"
           << job.predock_lateral_align_observed_motion_m << ","
           << "\"predock_lateral_align_detail\":"
           << json_string(job.predock_lateral_align_detail) << ","
           << "\"predock_lateral_align_failure_code\":"
           << json_string(job.predock_lateral_align_failure_code) << ","
           << "\"fine_bridge_settle_started\":"
           << (job.fine_bridge_settle_started ? "true" : "false") << ","
           << "\"fine_bridge_settle_complete\":"
           << (job.fine_bridge_settle_complete ? "true" : "false") << ","
           << "\"fine_bridge_settle_duration_sec\":" << job.fine_bridge_settle_duration_sec << ","
           << "\"fine_bridge_settle_remaining_translation_m\":"
           << job.fine_bridge_settle_remaining_translation_m << ","
           << "\"fine_bridge_settle_remaining_yaw_rad\":"
           << job.fine_bridge_settle_remaining_yaw_rad << ","
           << "\"fine_bridge_settle_failure_code\":"
           << json_string(job.fine_bridge_settle_failure_code) << ","
           << "\"fine_bridge_settle_detail\":"
           << json_string(job.fine_bridge_settle_detail) << ","
           ...
           << "\"fine_entry_lateral_m\":" << job.fine_entry_lateral_m << ","
