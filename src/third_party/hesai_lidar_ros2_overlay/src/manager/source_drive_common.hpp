...
public:
    ...
    bool GetDriveYamlParam(const YAML::Node& config, DriverParam &driver_param)
    {
        ...
        if (driver_config["remake_config"]) {
            YAML::Node remake_config = driver_config["remake_config"];
            YamlRead<bool>( remake_config, "flag",                driver_param.decoder_param.remake_config.flag, false);
            YamlRead<float>(remake_config, "min_azi",             driver_param.decoder_param.remake_config.min_azi, -1);
            YamlRead<float>(remake_config, "max_azi",             driver_param.decoder_param.remake_config.max_azi, -1);
            YamlRead<float>(remake_config, "ring_azi_resolution", driver_param.decoder_param.remake_config.ring_azi_resolution, -1);
            YamlRead<int>(  remake_config, "max_azi_scan",        driver_param.decoder_param.remake_config.max_azi_scan, -1);
            YamlRead<float>(remake_config, "min_elev",            driver_param.decoder_param.remake_config.min_elev, -1);
            YamlRead<float>(remake_config, "max_elev",            driver_param.decoder_param.remake_config.max_elev, -1);
            YamlRead<float>(remake_config, "ring_elev_resolution",driver_param.decoder_param.remake_config.ring_elev_resolution, -1);
            YamlRead<int>(  remake_config, "max_elev_scan",       driver_param.decoder_param.remake_config.max_elev_scan, -1);
        }
