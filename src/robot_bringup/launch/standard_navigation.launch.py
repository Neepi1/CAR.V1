...
def cpu_affinity_prefix(service_name):
    ...
    if (session and os.environ.get("NJRH_NAVIGATION_CPU_PROFILE") == "navigation_5cpu"
            and key in ("CONTROLLER_SERVER", "PLANNER_SERVER", "BEHAVIOR_SERVER",
                        "SMOOTHER_SERVER", "BT_NAVIGATOR", "VELOCITY_SMOOTHER",
                        "COLLISION_MONITOR", "WAYPOINT_FOLLOWER", "NAV2_MAP_SERVER",
